...
class Ui_AISearchingTechniquesMainWindow(object):
    ...
    def setupUi(self, AISearchingTechniquesMainWindow):
        ...
        self.GenerateGraphButton.setStyleSheet("background-color: blue;")
        self.AddNodesButton.setStyleSheet("background-color: green;")
        self.GeneratePathButton.setStyleSheet("background-color: orange;")
        self.AddNodeHeuristicButton.setStyleSheet("background-color: purple;")
        self.SubmitButton.setStyleSheet("background-color: yellow;")

        # Set the label colors
        self.TheResultLabel.setStyleSheet("color: red;")
        self.Node1Label.setStyleSheet("color: blue;")
        self.Node2Label.setStyleSheet("color: blue;")
        self.EdgeWieghtLabel.setStyleSheet("color: blue;")
        self.NodeLabel.setStyleSheet("color: blue;")
        self.NodeHeuristicLabel.setStyleSheet("color: blue;")
        self.StartNodeLabel.setStyleSheet("color: blue;")
        self.GoalNodeLabel.setStyleSheet("color: blue;")

        # Set the combobox colors
        self.SearchTypecomboBox.setStyleSheet("background-color: cyan;")
        self.GraphTypecomboBox.setStyleSheet("background-color: cyan;")
